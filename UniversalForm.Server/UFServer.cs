...
namespace UniversalForms.Server
{
    ...
    internal class UFServer
    {
        ...
        private ManualResetEvent _threadSync = new ManualResetEvent(false);
        private ArrayList _peers = new ArrayList();
        public UFServer(string hostName, uint port)
        {
            _hostName = hostName;
            _port = port;
        ...
        private async Task<IPEndPoint> CreateIPEndPoint()
        {
            ...
            return new IPEndPoint(ipAddress, 3000);
        }
